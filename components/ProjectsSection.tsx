...
const projects = [
  {
    ...
    image: `${basePath}/projects/blood-alert.jpg`,
  ...
  
  {
    ...
    image: `${basePath}/projects/library-system.jpg`,
    liveDemo: "https://github.com/Hakkim94/library-management-system",
    github: "https://github.com/Hakkim94/library-management-system",
    number: "02",
  },
];
      ...
      <div className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        <div ref={contentRef} className={`${isEven ? "lg:order-2" : "lg:order-1"} space-y-8 lg:space-y-10`}>
          ...
          <div className="flex flex-wrap gap-4 pt-4">
            <Button href={project.liveDemo}>Live Demo</Button>
